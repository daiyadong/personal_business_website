...
(function () {
    ...
    const DICT = {
        ...
        'srv1.desc':    { zh: '针对 Android / iOS 应用进行深度安全测试与代码审计，覆盖客户端、通信层及服务端全链路。', en: 'In-depth security testing and code auditing for Android / iOS applications, covering the full chain across client, communication, and server layers.' },
        ...
        'srv2.desc':    { zh: 'Web 应用 / API / 后端服务的全方位代码审计、渗透测试与安全评估。', en: 'Comprehensive code auditing, penetration testing, and security assessment for web applications, APIs, and backend services.' },
        'srv2.li1':     { zh: '源代码安全审计（CodeQL / SonarQube）', en: 'Source code security audit (CodeQL / SonarQube)' },
        'srv2.li2':     { zh: 'OWASP Top 10 全覆盖测试',  en: 'Full OWASP Top 10 coverage testing' },
        'srv2.li3':     { zh: 'API 安全 (REST/GraphQL/gRPC)', en: 'API security (REST/GraphQL/gRPC)' },
        'srv2.li4':     { zh: '业务逻辑漏洞深度挖掘',     en: 'Business logic vulnerability deep discovery' },
        'srv2.li5':     { zh: '数据库 & 中间件安全审计',  en: 'Database & middleware security audit' },
        'srv2.li6':     { zh: '认证鉴权体系安全评估',    en: 'Authentication & authorization system assessment' },
        ...
        'footer.nav_blog':   { zh: '技术博客',          en: 'Blog' },
